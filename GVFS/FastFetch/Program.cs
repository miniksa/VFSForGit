...
namespace FastFetch
{
    public class Program
    {
        public static int Main(string[] args)
        {
            ...
            var chunkSizeOpt = new Option<int>("--chunk-size") { Description = "Sets the number of objects to be downloaded in a single pack" };
            ...
            var maxRetriesOpt = new Option<int>("--max-retries") { Description = "Sets the maximum number of attempts for downloading a pack" };
