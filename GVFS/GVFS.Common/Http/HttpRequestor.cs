...
namespace GVFS.Common.Http
{
    public abstract class HttpRequestor : IDisposable
    {
        ...
        {
            // On .NET Core, ServicePointManager and machine.config are not applicable.
            // HttpClient handles TLS negotiation and connection pooling natively.
            // We keep the connection semaphore to throttle concurrent requests.
            int connectionLimit = Environment.ProcessorCount;
